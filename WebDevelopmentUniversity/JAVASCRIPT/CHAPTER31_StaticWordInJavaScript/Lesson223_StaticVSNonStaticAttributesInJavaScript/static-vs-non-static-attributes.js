class Person { // Implicitly extends Object class
    ...
    static counterPersonObjects = 0; // ! Static Attribute (Class)

    email = "Default Email Value"; // ! Attribute (Object)
...
console.log(Person.email); // ! Undefined (It's not static attribute)
console.log(Employee.email); // ! Undefined (It's not static attribute)